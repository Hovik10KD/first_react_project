...
const MyPosts = (props) => {
    ...
    let postsElement = props.postsData.map(post => <Post id={post.id} message={post.message} likesCount={post.likesCount} likeStatus={post.likeStatus} dispatch={props.dispatch}/>);
